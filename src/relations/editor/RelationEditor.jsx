...
import { TrashIcon, CheckIcon } from "@wacque/recogito-client-core";
import Autocomplete from "@wacque/recogito-client-core/src/editor/widgets/Autocomplete";
...
export default class RelationEditor extends Component {
  ...
  onSubmit = () => {
    ...
    if (value) {
      ...
      else this.props.onRelationUpdated(updatedRelation, this.props.relation);
    } else {
